/**
    ...
    @     PlayerSwap                     PLYRS              1-Trillion      @
    @                                                                       @
    @ @ @ @ @ @ @ @ @ @ @ @ @ @ @ @ @ @ @ @ @ @ @ @ @ @ @ @ @ @ @ @ @ @ @ @ @ 


   #PlayerSwap features:
   5% of fees auto add to the Liquidity Pool;
   2% of fees auto distribute to all Holders;
   3% of fees for Development Team & Marketing
 */
...
contract PlayerSwap is Context, IERC20, Ownable {
    ...
    string private _name = "PlayerSwap";
    string private _symbol = "PLYRS";
